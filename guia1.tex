...
\begin{enumerate}[label=\alph*.,font=\itshape]
    ...
    \\
    \\
    {Def. por comprensión: todas las cadenas de $\mathcal{L}$ tienen la misma cantidad de $a$ y $b$ y $\lambda \in \mathcal{L}$.}
    \\
    \\
    ...
    \\
    \\    
    {Def. por comprensión: las cadenas de $\mathcal{L}$ tienen al menos una $a$ y una $b$ (por lo tanto, $\lambda \notin \mathcal{L}$) y la cantidad de apariciones de $a$ es igual a la cantidad de apariciones de $b$.}
    \\
    \\
    ...
    \\
    \\
    {Def. por comprensión: las cadenas de $\mathcal{L}$ tienen al menos una $a$ (por lo tanto, $\lambda \notin \mathcal{L}$) y la cantidad de apariciones de $a$ no es necesariamente igual a la cantidad de apariciones de $b$.}
    \\
    \\
    ...
    \\
    \\
    {Def. por comprensión: como $p \geq 1$, las cadenas de $\mathcal{L}$ tienen al menos una aparición de $ac$. Además, como $q = p + 2$, tengo que $q \geq 3$, todas las cadenas de $\mathcal{L}$ tienen al menos tres apariciones de $bab$. La cantidad de apariciones de $bab$ depende de la cantidad de apariciones de $ac$. Las cadenas de $\mathcal{L}$ pueden no tener apariciones de $a$ y estas no dependen ni de $p$ ni de $q$.
    \\
    \\
